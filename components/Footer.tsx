...
const Footer = () => {
	return (
		<footer className="py-24 relative overflow-visible">
			{/* Background decorative elements */}
			<div className="absolute inset-0 pointer-events-none">
				<div className="absolute -bottom-40 -right-20 w-80 h-80 bg-padel-primary/10 rounded-full blur-3xl" />
				<div className="absolute -top-40 -left-20 w-80 h-80 bg-padel-primary/5 rounded-full blur-3xl" />
			</div>
			...
			<div className="container mx-auto px-4 relative z-10">
				<div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-10">
					...
					<div className="flex flex-col items-center md:items-start">
						...
						<p className="text-sm text-gray-300 text-center md:text-left max-w-xs leading-relaxed mx-auto md:mx-0">
					...
					<div className="w-full md:w-auto">
						...
						<div className="flex flex-col gap-8 md:grid md:grid-cols-3 md:gap-x-16 md:gap-y-8">
							{/* Enlaces */}
							<div className="flex flex-col items-center md:items-start">
				...
				<div className="mt-16 pt-6 border-t border-white/10 text-center">
					<p className="text-sm text-gray-400 flex items-center justify-center gap-1">
						...
						<a
							href="https://netsfera.com"
							target="_blank"
							rel="noopener noreferrer"
							className="inline-flex items-center hover:text-padel-primary transition-colors"
						>
							Creat per Netsfera amb
							<svg
								...
								height="18"
								fill="currentColor"
								className="inline-block ml-1 w-4 h-4 text-padel-primary transition-transform"
							> 
