...
export function ContactSection() {
	...
	const stats = [
		{ icon: Users, label: "Jugadors actius", value: "2,500+" },
		{ icon: Trophy, label: "Tornejos aquest any", value: "45" },
		{ icon: Calendar, label: "Partits jugats", value: "12,000+" },
	];
							...
							<div className="space-y-6">
								{stats.map((stat, index) => (
									<div key={index} className="flex items-center gap-4">
										<div className="w-12 h-12 bg-padel-primary/20 rounded-xl flex items-center justify-center">
											<stat.icon className="w-6 h-6 text-padel-primary" />
										</div>
										<div>
