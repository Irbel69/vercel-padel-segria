...
export function ContactSection() {
	...
	const handleSubmit = (e: React.FormEvent) => {
		...
		// Compose body in the requested template (Catalan)
		const messageText = formData.message || "(Cap missatge)";
		const bodyText =
			`Hola, soc en ${formData.name},\n` +
			`m'agradaria saber més informació sobre: ${messageText}\n\n` +
			`el meu numero de telefon es: ${formData.phone}\n`;
		...
		// Mark as submitting briefly to show UX feedback then open mail client
		setIsSubmitting(true);

		// Use window.open to trigger the mail client. This must run in browser.
		...
		console.log("Opening mail client with:", {
			recipient,
			subject,
			body: bodyText,
		});
